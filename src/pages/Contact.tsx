        ...
        <div id="contact" className="bg-black w-full px-[12%] py-20 pb-30 scroll-mt-20 bg-[url('./assets/footer-bg-color.png')] bg-no-repeat bg-[length:90%_auto] bg-center dark:bg-none">
            ...
            <form onSubmit={onSubmit} className="max-w-2xl mx-auto">
                ...
                <div className="grid grid-cols-auto gap-6 mt-10 mb-8">
                    <input type="text" placeholder="Enter your name" className="flex-1 px-3 py-2 focus:ring-1 outline-none border border-gray-700 dark:border-white/30 rounded-md text-white dark:bg-darkHover/30" required name="name" />

                    <input type="email" placeholder="Enter your email" className="flex-1 px-3 py-2 focus:ring-1 outline-none border border-gray-700 dark:border-white/30 rounded-md text-white dark:bg-darkHover/30" required name="email" />
                </div>
                <textarea rows="6" placeholder="Enter your message" className="w-full px-4 py-2 focus:ring-1 outline-none border border-gray-700 dark:border-white/30 rounded-md text-white mb-6 dark:bg-darkHover/30" required name="message"></textarea>
